/* ==========================================================================
   INTERVAL 2.0 - DATE & CALENDAR CALCULATIONS UTILITY
   ========================================================================== */
...
export function calculateStreak() {
    ...
    // If nothing completed today, we start checking from yesterday to see if current streak is intact
    if (!todayCompleted && !todayReviewed) {
        checkDate.setDate(checkDate.getDate() - 1);
    }

    const earliestDateStr = getEarliestDate();
    let daysChecked = 0;
    ...
    while (true) {
        ...
        // Safety cap to prevent infinite loop (maximum 365 days check)
